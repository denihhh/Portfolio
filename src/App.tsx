          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-7 space-y-6">
              ...
              <p className="max-w-xl text-sm sm:text-base leading-relaxed text-slate-400">
                ...
                Aspiring software developer interested in web development, networking, and
                creating secure, user-friendly applications through continuous learning and hands-on projects.
              </p>
